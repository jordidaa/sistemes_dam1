    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <div class="col-sm-5 col-md-6">
          <img id="myImg" class="imgcent2" src="../images/pb_sf_usb.jpg" alt="Placa base" style="width:100%;max-width:250px">
        </div>
        ...
        <div class="modal fade" id="myModal1" role="dialog">
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
              <img id="myImg" class="imgcentbtn" src="../images/pb_sf_usb.jpg" alt="Placa base" style="width:100%;max-width:600px"> 
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
              </div>
